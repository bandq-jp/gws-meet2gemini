...
const DEFAULT_BACKEND_URL = "http://localhost:8000/api/v1/marketing/chat/stream";
const BACKEND_URL =
  process.env.MARKETING_CHAT_STREAM_BACKEND_URL ||
  process.env.MARKETING_CHATKIT_BACKEND_URL?.replace("/chatkit", "/chat/stream") ||
  DEFAULT_BACKEND_URL;
